    ...
    <div className="relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none items-center">
        ...
        <form className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96">
            ...
            <div className="inline-flex items-center">
                <label className="relative -ml-2.5 flex cursor-pointer items-center rounded-full p-3" htmlFor="checkbox"
            ...
            <p
                ...
                <a className="font-medium text-pink-500 transition-colors hover:text-blue-700" href="#">
                    Sign In
                </a>
            </p>
        </form>
